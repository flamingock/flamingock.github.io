...
<Tabs groupId="languages">
  ...
  ```java
      Flamingock.builder()
          ...
          .setPipelineIgnoredListener(new PipelineIgnoredListener())
          ...
          .setStageIgnoredListener(new StageIgnoredListener())
  ...
  ```kotlin
      Flamingock.builder()
          ...
          .setPipelineIgnoredListener(PipelineIgnoredListener())
          ...
          .setStageIgnoredListener(StageIgnoredListener())
