...
| --- | --- | --- | --- |
| `skipImport`  <VersionBadge version="1.2.0" /> | `String` | "" | Determines whether Mongock audit import is skipped. Supports literal values and placeholders. Allowed values are `true`, `false`, or empty. When empty (default), it is treated as `false` (import enabled). When `true`, import is skipped. |
